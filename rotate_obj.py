...
def process_obj_line(line, axis, angle):
    """Verarbeitet eine Zeile aus einer .obj-Datei, dreht Vertices oder Normalen und gibt die aktualisierte Zeile zurück."""
    parts = line.split()
...
def rotate_obj_file(input_file, axis, angle):
    """Liest eine .obj-Datei, rotiert die Vertices und Normalen um die angegebene Achse und den Winkel und speichert sie in einer neuen Datei."""
